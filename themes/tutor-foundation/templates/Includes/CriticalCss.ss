...
.push-9{ position: relative; left: 75%; right: auto; }
 ...
 .button{ border-top-style: solid; border-right-style: solid; border-bottom-style: solid; border-left-style: solid; border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px; cursor: pointer; font-family: proxima-nova-alt, sans-serif; font-weight: normal; line-height: normal; margin-top: 0px; margin-right: 0px; margin-bottom: 1.25rem; margin-left: 0px; position: relative; text-decoration: none; text-align: center; -webkit-appearance: none; border-top-left-radius: 0px 0px; border-top-right-radius: 0px 0px; border-bottom-right-radius: 0px 0px; border-bottom-left-radius: 0px 0px; display: inline-block; padding-top: 1rem; padding-right: 2rem; padding-bottom: 1.0625rem; padding-left: 2rem; font-size: 1rem; background-color: rgb(82, 117, 165); border-top-color: rgb(66, 94, 132); border-right-color: rgb(66, 94, 132); border-bottom-color: rgb(66, 94, 132); border-left-color: rgb(66, 94, 132); color: rgb(255, 255, 255); }
 .button.radius{ border-top-left-radius: 20px 20px; border-top-right-radius: 20px 20px; border-bottom-right-radius: 20px 20px; border-bottom-left-radius: 20px 20px; }
@media only screen and (min-width: 40.063em){
...
.reveal-modal{ visibility: hidden; display: none; position: absolute; z-index: 1005; top: 0px; border-top-left-radius: 20px 20px; border-top-right-radius: 20px 20px; border-bottom-right-radius: 20px 20px; border-bottom-left-radius: 20px 20px; left: 0px; background-color: rgb(255, 255, 255); border-top-style: solid; border-right-style: solid; border-bottom-style: solid; border-left-style: solid; border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px; border-top-color: rgb(102, 102, 102); border-right-color: rgb(102, 102, 102); border-bottom-color: rgb(102, 102, 102); border-left-color: rgb(102, 102, 102); box-shadow: rgba(0, 0, 0, 0.398438) 0px 0px 10px; padding-top: 2.0625rem; padding-right: 2.0625rem; padding-bottom: 2.0625rem; padding-left: 2.0625rem; }
...
.top-bar-section .divider{ border-top-style: solid; border-top-width: 1px; border-top-color: rgb(68, 68, 68); clear: both; height: 1px; width: 100%; }
...
.top-bar-section ul li > a{ display: block; width: 100%; color: rgb(255, 255, 255); padding-top: 12px; padding-right: 0px; padding-bottom: 12px; padding-left: 1.25rem; font-family: proxima-nova-alt-condensed, sans-serif; font-size: 1.375rem; font-weight: normal; text-transform: uppercase; }
.top-bar-section ul li > a.button{ font-size: 1.375rem; padding-right: 1.25rem; padding-left: 1.25rem; background-color: rgb(82, 117, 165); border-top-color: rgb(66, 94, 132); border-right-color: rgb(66, 94, 132); border-bottom-color: rgb(66, 94, 132); border-left-color: rgb(66, 94, 132); color: rgb(255, 255, 255); }
...
.tutor-card-list{ display: block; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px; margin-top: 0px; margin-right: -0.625rem; margin-bottom: 0px; margin-left: -0.625rem; }
.tutor-card-list::before, .tutor-card-list::after{ content: ' '; display: table; }
.tutor-card-list::after{ clear: both; }
.tutor-card-list > li{ display: block; height: auto; float: left; padding-top: 0px; padding-right: 0.625rem; padding-bottom: 1.25rem; padding-left: 0.625rem; }
.tutor-card-list > li{ width: 100%; padding-top: 0px; padding-right: 0.625rem; padding-bottom: 1.25rem; padding-left: 0.625rem; list-style-type: none; list-style-position: initial; list-style-image: initial; }
...
.tutor-card-list::after{ clear: both; }
.tutor-card-list > li{ display: block; height: auto; float: left; padding-top: 0px; padding-right: 0.625rem; padding-bottom: 1.25rem; padding-left: 0.625rem; }
.tutor-card-list > li{ width: 50%; padding-top: 0px; padding-right: 0.625rem; padding-bottom: 1.25rem; padding-left: 0.625rem; list-style-type: none; list-style-position: initial; list-style-image: initial; }
.tutor-card-list > li:nth-of-type(1n){ clear: none; }
.tutor-card-list > li:nth-of-type(2n+1){ clear: both; }
}
.tutor-card-list li{ border-right-width: 1px; border-right-style: solid; border-right-color: rgb(238, 238, 238); margin-top: 0px; margin-right: 0px; margin-bottom: 0px; margin-left: 0px; }
.tutor-card-list li img{ display: block; }
.tutor-card-list a{ color: rgb(0, 0, 0); }
.tutor-card-list h4{ color: rgb(82, 117, 165); }
...
.announcements{ display: block; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px; margin-top: 0px; margin-right: -0.625rem; margin-bottom: 0px; margin-left: -0.625rem; }
.announcements::before, .announcements::after{ content: ' '; display: table; }
.announcements::after{ clear: both; }
.announcements > li{ display: block; height: auto; float: left; padding-top: 0px; padding-right: 0.625rem; padding-bottom: 1.25rem; padding-left: 0.625rem; }
.announcements > li{ width: 100%; padding-top: 0px; padding-right: 0.625rem; padding-bottom: 1.25rem; padding-left: 0.625rem; list-style-type: none; list-style-position: initial; list-style-image: initial; }
...
.announcements::after{ clear: both; }
.announcements > li{ display: block; height: auto; float: left; padding-top: 0px; padding-right: 0.625rem; padding-bottom: 1.25rem; padding-left: 0.625rem; }
.announcements > li{ width: 50%; padding-top: 0px; padding-right: 0.625rem; padding-bottom: 1.25rem; padding-left: 0.625rem; list-style-type: none; list-style-position: initial; list-style-image: initial; }
.announcements > li:nth-of-type(1n){ clear: none; }
.announcements > li:nth-of-type(2n+1){ clear: both; }
}
.announcements.small{ display: block; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px; margin-top: 0px; margin-right: -0.625rem; margin-bottom: 0px; margin-left: -0.625rem; }
.announcements.small::before, .announcements.small::after{ content: ' '; display: table; }
.announcements.small::after{ clear: both; }
.announcements.small > li{ display: block; height: auto; float: left; padding-top: 0px; padding-right: 0.625rem; padding-bottom: 1.25rem; padding-left: 0.625rem; }
.announcements.small > li{ width: 100%; padding-top: 0px; padding-right: 0.625rem; padding-bottom: 1.25rem; padding-left: 0.625rem; list-style-type: none; list-style-position: initial; list-style-image: initial; }
.announcements.small > li:nth-of-type(1n){ clear: none; }
.announcements.small > li:nth-of-type(1n+1){ clear: both; }
.announcements.small li{ padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px; }
.announcements .announcement-card hr{ margin-top: 0px; margin-right: 0px; margin-bottom: 0px; margin-left: 0px; }
...
.top-bar h1{ max-width: 12.5rem; }
@media only screen and (min-width: 64.063em){
.top-bar h1{ max-width: 18.75rem; }
}
.top-bar .top-bar-section ul li a.button{ font-size: 0.9rem; }
