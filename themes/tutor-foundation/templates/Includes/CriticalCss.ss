...
.banner{ text-transform: uppercase; font-size: 1rem; background-image: initial; background-attachment: initial; background-origin: initial; background-clip: initial; background-color: rgb(238, 238, 238); color: rgb(34, 34, 34); position: relative; padding-top: 3px; padding-right: 3px; padding-bottom: 3px; padding-left: 3px; background-position: initial initial; background-repeat: initial initial; }
