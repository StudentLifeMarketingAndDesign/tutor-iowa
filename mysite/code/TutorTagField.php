 ...
 * @subpackage tagfield
 */
class TutorTagField extends TextField {
	...
	public function Field($properties = array()) {
		...
		Requirements::javascript("mysite/tutortagfield/thirdparty/jquery-tags/jquery.tags.js");
		Requirements::javascript("mysite/tutortagfield/javascript/TagField.js");
		Requirements::css("mysite/tutortagfield/css/TagField.css");
	...
	public function getAttributes() {
		...
		$custom = array(
			'autocomplete' => 'off',
			'class' => $attrs['class'] . ' tutorTagField text',
