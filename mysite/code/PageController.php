...
class PageController extends ContentController {
	...
	public function FeedbackForm() {
		...
		$fields = new FieldList(
			...
			new TextField('Name', 'Your Name', $memberName),
			new EmailField(Email::class, 'Your Email Address', $memberEmail),
			$checkbox,
		...
		// Create action
		$validator = new RequiredFields('Name', Email::class, 'Feedback');
	...
	public function LogoutLink() {
		...
		return Controller::join_links(Director::absoluteBaseURL() . Config::inst()->get(Security::class, 'logout_url'), $backURL);
	}
